...
const slides = [
  {
    ...
    description:
      "Experience authentic Pinddaan ceremonies at the sacred Vishnupad Temple, where Lord Vishnu's footprints are preserved for eternal blessings.",
  ...
  },
  {
    ...
    description:
      "Get complete guidance and authentic rituals performed by our experienced pandit who has dedicated his life to serving devotees with traditional Vedic practices.",
  ...
  },
  {
    ...
    description:
      "From Pinddaan to Asthi Visarjan, we provide complete spiritual services following ancient traditions with proper mantras and complete dedication.",
  ...
  {
    id: 4,
    title: "Sacred Pilgrimage Spots",
    subtitle: "Explore holy sites of Gaya Ji",
    description:
      "Perform rituals at spiritually powerful locations like Brahma Kund, Sita Kund, and Ram Gaya—each filled with divine significance and blessings.",
    image: "/homepage/slider/card-1.jpeg",
    cta: "Contact Us",
    ctaLink: "/contact",
    altText: "Sacred ritual sites in Gaya Ji",
  },
  {
    id: 5,
    title: "Meaningful Ritual Experience",
    subtitle: "Guided with devotion and care",
    description:
      "Every ceremony is performed with proper Vedic mantras, ensuring peace for ancestors and blessings for the entire family.",
    image: "/homepage/slider/card-2.jpeg",
    cta: "Contact Us",
    ctaLink: "/contact",
    altText: "Traditional rituals being performed",
  },
  {
    id: 6,
    title: "Plan Your Visit with Ease",
    subtitle: "Complete support for devotees",
    description:
      "We assist you at every step—from arrangements to rituals—so you can focus on devotion and spiritual fulfillment during your sacred journey in Gaya Ji.",
    image: "/homepage/slider/card-3.jpeg",
    cta: "Contact Us",
    ctaLink: "/contact",
    altText: "Devotees performing rituals with guidance",
  },
];
...
export default function HeroSlider() {
  ...
  return (
    <section className="relative h-full overflow-hidden bg-gradient-to-br from-orange-900 via-red-900 to-orange-800">
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <div className="absolute inset-0 opacity-5">
            ...
            <div className="absolute top-32 right-20 text-4xl text-white">
              🪷
            </div>
            <div className="absolute bottom-20 left-20 text-5xl text-white">
              🔱
            </div>
            <div className="absolute bottom-32 right-32 text-3xl text-white">
              🕉️
            </div>
          </div>
          ...
          <div className="container mx-auto px-4 h-full min-h-screen">
            ...
            <div className="lg:hidden flex flex-col min-h-screen h-full">
              {/* Mobile Image */}
              <motion.div
                initial={{ opacity: 0, y: -30 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.2, duration: 0.6 }}
                className="relative sm:h-80 mt-20 mb-8 rounded-2xl overflow-hidden shadow-2xl !aspect-square !w-full !h-full"
              >
                <Image
            ...
            <div className="hidden lg:flex items-center min-h-screen h-full py-20">
              {/* Desktop Content */}
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                    <Link
                      ...
                      className="px-8 py-4 bg-gradient-to-r from-orange-500 to-red-600 text-white font-semibold rounded-lg hover:from-orange-600 hover:to-red-700 transform hover:scale-105 transition-all duration-300 shadow-lg"
                    >
                      <FontAwesomeIcon
                        icon={faPrayingHands}
                        className="w-4 h-4 mr-2"
              ...
              <div className="w-1/2">
                <motion.div
                  ...
                  className="relative rounded-2xl overflow-hidden shadow-2xl aspect-square w-auto h-auto"
                >
                  <Image
                    src={slides[currentSlide].image}
                    alt={slides[currentSlide].altText}
